...
ResAnalyFile = parent_directory+'/Output/Results_actualcase/Kolbeinseyridge/'
...
model = load_model(parent_directory +'/Output/Results_DC/best_model_With_Add_Normed_lr1ef4_epoch500_batch501_layer9_15_3' +'.h5',custom_objects={'R2':R2})
...
# (2)Mohnsridge
plt.subplot(2, 1, 2)
ResAnalyFile = parent_directory +'/Output/Results_actualcase/Mohnsridge/'
